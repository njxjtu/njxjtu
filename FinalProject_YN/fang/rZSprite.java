 ...
 * @author Jam Jenkins
 */
public class rZSprite extends Sprite 
{
	/**
	...
	public rZSprite()
	{
		...
		path.moveTo((float) 0.0, (float) 2.0);
		path.lineTo((float) 0.0, (float) 4.0);
		path.lineTo((float) 4.0, (float) 4.0);
		path.lineTo((float) 4.0, (float) 2.0);
		path.lineTo((float) 6.0, (float) 2.0);
		path.lineTo((float) 6.0, (float) 0.0);
		path.lineTo((float) 2.0, (float) 0.0);
		path.lineTo((float) 2.0, (float) 2.0);
		path.closePath();
		setShape(path);
	}
